    ...
    : IRequestHandler<GetInteractionsByContactQuery, IReadOnlyList<InteractionDto>>
{
    ...
    {
        // FIX F: .Take(200) removed here — it now lives inside
        // InteractionRepository.GetByContactAsync where EF translates it
        // to SQL TOP 200 before data is transferred. The old in-memory
        // Take loaded all rows then discarded most of them.
