...
public class ApiClient : ApiClientBase
{
    ...
    // Donations
    public Task<ApiResponse<PagedResult<DonationListDto>>> GetDonationsAsync(PaginationParams p, Guid? contactId = null, DateOnly? fromDate = null, DateOnly? toDate = null, Guid? campaignId = null, Guid? projectId = null)
    ...
    public Task<ApiResponse<NewsletterPreviewDto>> PreviewNewsletterAsync(Guid campaignId, string? tagFilter)
    ...
    public Task<ApiResponse<NewsletterResultDto>> SendCampaignNewsletterAsync(Guid campaignId, LifeCrm.Application.Campaigns.DTOs.SendNewsletterRequest req)
        => PostAsync<NewsletterResultDto>($"api/v1/campaigns/{campaignId}/newsletter/send", req);
